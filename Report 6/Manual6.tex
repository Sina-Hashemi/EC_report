...
\begin{question}
    ...
    \begin{subquestion}{Devise an experiment to measure the input and output resistance of the amplifier module.}
        \answer{
            \begin{figure}[H]
                \centering
                \includegraphics[scale=\PicScale,angle=0]{Fig/123456.jpeg}
                \caption{note for mohammad Mahdi, delete after read!!!!! its for helping you to write report and \textbf{should not be in final report}}
            \end{figure}
            \begin{figure}[H]
                \centering
