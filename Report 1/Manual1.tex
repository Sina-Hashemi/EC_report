...
\begin{question}
    ...
    \answer{
        ...
        \paragraph*{}
        We connected the ground base of both input channels of the oscilloscope to the ground base of the function generator. We also connected the other end of the probe of the first channel to point A and the other end of the probe of the second channel to point B, and using the subtraction option of the oscilloscope subtracted these two waves to obtain the potential difference between the two ends of the resistance.
