...
\begin{question}
    ...
    \begin{subquestion}{Repeat the previous part for a $100$ k$\Omega$ resistor. What happens if you touch the probes of the multi-meter while measuring the resistance?}
        \answer{
            ...
            \paragraph*{}
            The measured resistance of resistor itself is $98.01$ k$\Omega$.
            When the probes are touched, the resistance is $85.41$ k$\Omega$.
            When the probes are touched, the total resistance is less than the resistance of the resistor itself
            because the total resistance is equal to the sumation of parallel resistance of the resistor
            and the trajectory of the human body (from hand to hand).
        }
    \end{subquestion}
