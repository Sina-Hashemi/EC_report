...
\begin{question}
    ...
    \begin{subquestion}{Measure the resistance of a carbon resistor in room temperature. Redo the measurement when the resistor is heated by a soldering iron and when is cooled by a cooling spray. }
        \answer{
            \begin{figure}[H]
                \centering
                \includegraphics[scale=0.25,angle=0]{Fig/53.png}
                \includegraphics[scale=0.25,angle=0]{Fig/54.png}
            \end{figure}
            Lab supervisor used $1k\Omega$ resistor. \\
            The resistance decrease by warming resistor($964\Omega$). \\
            The resistance increase by cooling resistor($1033\Omega$).
        }
    \end{subquestion}
    ...
    \begin{subquestion}{Repeat the previous part for a metal film resistor, a ceramic capacitor, and a multi-layer capacitor. }
        \answer{
            \begin{figure}[H]
                \centering
                \includegraphics[scale=0.25,angle=0]{Fig/55.png}
                \includegraphics[scale=0.25,angle=0]{Fig/56.png}
                \includegraphics[scale=0.25,angle=0]{Fig/57.png}
            \end{figure}
            Lab supervisor used $340pC$ ceramic capacitor.
            The capacity decrease by warming capacitor($310pC$). \\
            The capacity increase by cooling capacitor($350pC$). \\
            It seems that the capacitor is more sensitive to temperature increase than temperature decrease
        }
    \end{subquestion}
...
\begin{question}
    ...
    \answer{
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.25,angle=0]{Fig/50.png}
            \includegraphics[scale=0.25,angle=0]{Fig/51.png}
            \includegraphics[scale=0.25,angle=0]{Fig/52.png}
        \end{figure}
        When a $0.25$ W, $10$ $\Omega$ resistor is connected to a DC power supply
...
\begin{question}
    ...
    \begin{subquestion}{Connect a $16$ V aluminum electrolytic capacitor directly to a $30$ V DC voltage and observe the results.}
        \answer{
            ...
            As can be seen, when a $16$ V aluminum electrolytic capacitor is connected
    ...
    \begin{subquestion}{Connect a $16$ V aluminum electrolytic capacitor inversely to a $16$ V DC voltage and observe the results.}
        \answer{
            When a $16$ V aluminum electrolytic capacitor is connected inversely
...
\begin{question}
    ...
    \begin{subquestion}{Replace $D$ with a $1$ k$\Omega$ resistor and see the corresponding characteristic curve on the oscilloscope screen.}
        \answer{
            ...
            As can be seen, the characteristic curve of a resistor is a straight line with a slope of $1$.
        }
    \end{subquestion}
    ...
    \begin{subquestion}{Repeat the previous part for a diode.}
        \answer{
            ...
            As can be seen, the diode has non-linear characteristic curve.
            It passes current only in one direction and has a voltage drop of almost
            $0.7V$ when it's forward biased.
        }
    \end{subquestion}
