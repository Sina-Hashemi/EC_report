...
\begin{question}
    ...
    \begin{subquestion}{Measure the voltages of the circuit using a multimeter and verify the KVL $v_s=v_1+v_2$.}
        \answer{
            ...
            \begin{figure}[H]
                ...
                \includegraphics[scale=0.1,angle=0]{Fig/3.jpeg}
                \caption{$v_1$ and $v_2$ measured by multimeter.}
            \end{figure}
            $v_1$ + $v_2$ = 3.35 + 1.67 = 5.02 V, compared to $v_s$ = 5.00 V ,
            the error is 0.02 V.
        }
    \end{subquestion}
    ...
    \begin{subquestion}{Measure the currents of the circuit indirectly using a multimeter and verify the KCL $i_1=i_2+i_3$.}
        \answer{
            ...
            \end{figure}
            Since the current identifier of the multimeter is not working, we cannot measure the current directly. However, we can calculate it using Ohm's law.

            \[
                i_1 = \frac{v_1}{R_1} = \frac{3.35}{1.012} = 3.31 \, \text{mA}, \quad
                i_2 = \frac{v_2}{R_2} = \frac{1.67}{1.018} = 1.64 \, \text{mA}, \quad
                i_3 = \frac{v_3}{R_3} = \frac{1.67}{1.016} = 1.64 \, \text{mA}
            \]

            So, we have $i_1 = i_2 + i_3 = 3.31 \, \text{mA} = 1.64 \, \text{mA} + 1.64 \, \text{mA} = 3.28 \, \text{mA}$. The error is 0.03 \, \text{mA}.
    ...
    \begin{subquestion}{Reverse the direction of the current $i_2$ and the polarity of the voltage $v_3$ in Fig. \ref{fig:cir1} and repeat the previous parts. }
        \answer{
            ...
            \end{figure}
            The results are the same as the previous parts. The error is 0.03 \, \text{mA}.
    ...
    \begin{subquestion}{Change the resistors to $10$ k$\Omega$ and repeat the previous parts. }
        \answer{
            ...
            So, we have $i_1 = i_2 + i_3 = 0.34$ \, \text{mA} = 0.17 \, \text{mA} + 0.17 \, 
            \text{mA} = 0.34 \, \text{mA}. The error is 0.00 \, \text{mA}.
            ...
            The results are the same as the previous parts. The error is 0.00 \, \text{mA}.
...
\begin{question}
    ...
    \begin{subquestion}{Verify the KCL $i_1=i_2+i_4$ graphically using the oscilloscopes.}
        \answer{
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[scale=0.1,angle=0]{Fig/16.jpeg}
    ...
    \begin{subquestion}{Change the square wave to sine wave and repeat the previous part.}
        \answer{
            \begin{figure}[H]
                \centering
                \includegraphics[scale=0.1,angle=0]{Fig/18.jpeg}
    ...
    \begin{subquestion}{Redo the previous parts when the capacitor is replaced with a diode.}
        \answer{
            ...
            \begin{figure}[H]
                ...
                \includegraphics[scale=0.1,angle=0]{Fig/22.jpeg}
...
\begin{question}
    ...
    \answer{
        \lstinputlisting[style=Matlab-Pyglike]{code/zero.m}
    }
...
\begin{question}
    ...
    \answer{
        Here is the estimated characteristic curve of the resistor and its resistance:\\
        The resistance of the resistor is 2218.80 Ohms (code output). \\
        \begin{figure}[H]
            \includegraphics[scale=0.70,angle=0]{Fig/Q4_1.png}
            \caption{The characteristic curve of the resistor.}
        \end{figure}

        The Matlab code used to estimate the characteristic curve of the resistor and its resistance is as follows:
